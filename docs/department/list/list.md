...
A department lets you group people or mailboxes by team — for example Sales, HR, or IT — so they're easier to organize and manage together.

Where to find it: click Departments in the left menu.

## 3.1 The Departments List

This page lists every department you've created, along with when each one was created and last updated.
...
Click the Actions button (top right) for ways to work with departments in bulk:
