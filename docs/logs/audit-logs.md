...
The Logs menu lets you look up what's happened in your system — who did what, what mail was sent, and who tried to log in. It has three screens: Audit, Mail Flow and Email Login Attempts.

Where to find it: click Logs in the left menu, then the kind of log you want.

## 9.1 Audit Logs

Audit Logs record every change made in the panel — policies created or deleted, users added, permissions changed, logins and logouts, and more.
