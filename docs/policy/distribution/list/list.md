## 8.5 Distribution Policies

A distribution policy turns a mailbox into a group address — mail sent to it is meant for multiple people. It controls who is allowed to send to that mailbox, and who its members are.

Where to find it: click Policies in the left menu, then Distribution.

This page lists every distribution policy you've created, for the domain selected at the top right.
...
Click the Actions button (top right) for ways to work with distribution policies in bulk — the same as General Policies, see section 8.1:
