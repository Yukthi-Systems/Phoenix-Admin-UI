...
Click Edit Identity to update an existing identity. It's a 3-step form that covers much the same ground as Adding a New Identity (section 4.5.4), with a couple of differences called out below — there's no Preview step here, and the Update Identity button appears at the bottom of every step, not just the last one, so you can save your changes as soon as you're done without stepping through the rest.

**Step 1 of 3 — Identity Info.**
