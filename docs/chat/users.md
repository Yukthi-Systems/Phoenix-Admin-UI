...
The Chat menu controls which identities can use chat, and the chat rules for your whole organization. It has two screens: Chat Users and Chat Preference.

Where to find it: click Chat in the left menu, then Chat Users or Chat Preference.

## 6.1 Chat Users

This page lists every identity that currently has chat enabled, for the domain selected at the top right.
