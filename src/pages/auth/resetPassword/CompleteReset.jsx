...
const Step2CompleteReset = ({ username, verifyMethod, onBack }) => {
            ...
            <OtpInput
              ...
              renderInput={(props) => (
                <input
                  ...
                  {...props}
                  autoComplete="off"
                  className={`cosmic-input !h-11 !w-11 rounded-lg border text-center text-lg font-semibold uppercase transition-all duration-200 sm:!h-12 sm:!w-12 ${
                    otpError
...
export default Step2CompleteReset;
