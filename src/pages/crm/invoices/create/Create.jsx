...
function InvoiceCreationWrapper() {
  ...
  const steps = ["Basic Details", "Items & Tax Calculation"];
    ...
    try {
      ...
      const initialData = {
        ...
        basic_details: {
          ...
          // Add client and company details to basic_details as requested
          client_details: step1Data.client_details,
          company_details: COMPANY_DATA,
        },
        due_date: step1Data.due_date, // Already formatted in step1
        invoice_date: step1Data.invoice_date, // Already formatted in step1
      ...
      const invoiceData = {
        ...
        invoice_id: step1Data.invoice_id,
        revision_date: step1Data.invoice_date,
        revision_number: 1,
      };
  ...
  const generatePDFBlob = async (combinedData) => {
    try {
      const invoiceDetails = {
        ...
        date: new Date(combinedData.invoice_date).toLocaleDateString("en-IN"),
        po_date: new Date(combinedData.invoice_date).toLocaleDateString(
          "en-IN",
        ),
        state_code: combinedData.client_details?.state_code || "29",
        gstin_code:
          combinedData.client_details?.gst_number || COMPANY_DATA.gst_number,
        items:
