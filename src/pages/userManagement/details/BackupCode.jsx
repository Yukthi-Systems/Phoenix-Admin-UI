...
import StepBackupCode from "@/pages/profile/twoFactAuthSteps/StepBackupCode";
...
function BackupCode({
  ...
  const generateBackupCodes = () => {
    genBackup(
      { orgId: organization_id, user_id: user_id, userName: name },
      {
        onSuccess: (response) => {
                ...
                <div className="flex gap-3">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-muted-foreground text-left">
                      {name} have {data?.valid_backup_codes_count || 0} unused
