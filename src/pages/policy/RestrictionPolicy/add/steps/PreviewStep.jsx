    ...
    <div className="space-y-6">
      <div className="text-left">
        ...
        <p className="text-muted-foreground mt-1 text-sm">
          Please review all settings before creating the restrictions policy
        </p>
      </div>
      ...
      {/* Restrictions */}
      {(geoList.length > 0 || ipList.length > 0) && (
        <PreviewSection title="Restrictions">
          {geoList.length > 0 && (
            <PreviewList label="Geo Locations" items={geoList} />
          )}
          {ipList.length > 0 && (
            <PreviewList label="IP Addresses" items={ipList} />
          )}
        </PreviewSection>
      )}
        ...
        <div className="flex items-start gap-3">
          ...
          <div className="text-left">
            ...
            <p className="text-muted-foreground mt-1 text-sm">
              ...
              is configured and ready to be created. Click "Create restrictions
              Policy" to proceed.
            </p>
          </div>
        </div>
