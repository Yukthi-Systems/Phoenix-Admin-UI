...
const PreviewStep = ({
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Distributions */}
      {(forwardToEmails.length > 0 || forwardToEmails.length > 0) && (
        <PreviewSection title="Distributions">
          {forwardToEmails.length > 0 && (
            <PreviewList label="Forward To Emails" items={forwardToEmails} />
          )}
          {fromEmails.length > 0 && (
            <PreviewList label="From Emails" items={fromEmails} />
          )}
          {subjectContains.length > 0 && (
            <PreviewList label="Subject Contains" items={subjectContains} />
          )}
        </PreviewSection>
      )}
