...
import { FiltersPolicyInfiniteSelectField } from "@/components/common/infiniteSelectors/FilterPolicyInfiniteScroll";
import { AttachmentPolicyInfiniteSelectField } from "@/components/common/infiniteSelectors/AttachementPolicyInfiniteScroll";
    ...
    <div className="space-y-6">
      <div className="text-left">
        ...
        <p className="text-muted-foreground mt-1 text-sm">
          Configure spam handling, caution and disclaimer templates, and filter
          policies
        </p>
      </div>
      ...
      <fieldset className="border-border rounded-md border p-6">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          <FiltersPolicyInfiniteSelectField
            control={control}
            name="filter_policy_id"
            label="Filter Policy"
            errors={errors}
            organizationId={organization_id}
          ...
          <AttachmentPolicyInfiniteSelectField
            control={control}
            name="attachment_policy_id"
            label="Attachment Policy"
            errors={errors}
            organizationId={organization_id}
            domainName={domain_name}
            placeholder="Select an attachment policy..."
          />
        </div>
      </fieldset>
    </div>
