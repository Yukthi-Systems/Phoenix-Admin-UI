        ...
        <div className="grid grid-cols-1 gap-5 ">
          <div className="flex items-center">
            <Switch
              ...
              falseSublabel={
                isEditMode
                  ? "Server is disabled for mail handling"
                  : "Server will be created but remain disabled"
              }
              trueLabel="Server Active"
              trueSublabel={
                isEditMode
                  ? "Server is enabled for mail handling"
                  : "Server will be enabled immediately after creation"
              }
            />
          </div>
          <div className="flex items-center">
